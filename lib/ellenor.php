...
//a param tömböt járja be a cserel függvény, ide kell beírni a használt változókat.
     ...
     * @param $reg_ex
     * @param $text
     * @param $parancsazonosíto a meghívó függvény beazanosítása nem kötelező
     * @return int (0 ha nem talált egyezést 1 ha talál,false ha hibát ad vissza a preg match)
     */
